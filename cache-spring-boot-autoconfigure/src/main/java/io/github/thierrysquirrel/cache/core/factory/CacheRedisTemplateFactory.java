...
import io.github.thierrysquirrel.cache.core.redis.serialize.CacheSerializer;
import io.github.thierrysquirrel.cache.core.redis.template.CacheRedisTemplate;
import org.springframework.data.redis.connection.RedisConnectionFactory;

/**
 * ClassName: CacheRedisTemplateFactory
 * Description:
 * date: 2020/5/24 1:53
 *
...
public class CacheRedisTemplateFactory {
    ...
    public static CacheRedisTemplate createCacheRedisTemplate(RedisConnectionFactory redisConnectionFactory, CacheProperties cacheProperties) {
        CacheRedisTemplate template = new CacheRedisTemplate (cacheProperties);
        template.setConnectionFactory (redisConnectionFactory);
        template.setDefaultSerializer (new CacheSerializer ());
        return template;
    }
}
