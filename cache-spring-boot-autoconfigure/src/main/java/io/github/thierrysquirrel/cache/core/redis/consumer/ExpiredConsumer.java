 ...
 */
package io.github.thierrysquirrel.cache.core.redis.consumer;

import io.github.thierrysquirrel.cache.core.factory.execution.CaffeineTemplateFactoryExecution;
import io.github.thierrysquirrel.cache.core.template.CaffeineTemplate;
import io.github.thierrysquirrel.cache.core.utils.ConsumerUtils;
...
public class ExpiredConsumer implements MessageListener {
    ...
    public void onMessage(@NonNull Message message, byte[] pattern) {
        ...
        if (cache) {
            ...
            log.debug ("ExpiredConsumer"+ message);
        }
    }
}
