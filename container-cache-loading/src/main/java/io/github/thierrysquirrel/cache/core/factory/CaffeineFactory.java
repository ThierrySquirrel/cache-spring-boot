...
public class CaffeineFactory {
    ...
    public static Cache<String, CacheDomain> createCaffeine(CacheLoading cacheLoading) {
        return Caffeine.newBuilder()
                .initialCapacity(cacheLoading.getInitialCacheCapacity())
                .maximumSize(cacheLoading.getMaximumCacheCapacity())
                .expireAfterWrite(cacheLoading.getExpirationTime(), TimeUnit.SECONDS)
                .build();
    }
}
