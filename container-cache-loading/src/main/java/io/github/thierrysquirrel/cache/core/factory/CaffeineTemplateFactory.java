...
public class CaffeineTemplateFactory {
    ...
    public static CaffeineTemplate createCaffeineTemplate(CacheLoading cacheLoading) {
        Cache<String, CacheDomain> caffeine = CaffeineFactory.createCaffeine(cacheLoading);
